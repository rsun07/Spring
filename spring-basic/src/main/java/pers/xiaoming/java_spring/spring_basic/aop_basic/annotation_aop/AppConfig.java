package pers.xiaoming.java_spring.spring_basic.aop_basic.annotation_aop;
...
@Configuration
@ComponentScan("pers.xiaoming.java_spring.spring_basic.aop_basic.annotation_aop")
public class AppConfig {
    ...
    // otherwise java_spring will use <JDK dynamic proxies> by default which only proxy Interface
