...
public class DynamicProxyTest {
    ...
    /*
        Class name is : pers.xiaoming.java_spring.cglib_dynamic_proxy.NoInterfaceCalculator$$EnhancerByCGLIB$$85b80530
        Super Class is : class pers.xiaoming.java_spring.cglib_dynamic_proxy.NoInterfaceCalculator
