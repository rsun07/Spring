...
import pers.xiaoming.java_spring.jdk_dynamic_proxy.advanced.ChargableCalculator;
import pers.xiaoming.java_spring.jdk_dynamic_proxy.advanced.ChargableCalculatorSeparatedInterfacesImpl;
import pers.xiaoming.java_spring.jdk_dynamic_proxy.advanced.ChargableCalculatorSeparatedInterfacesProxy;
import pers.xiaoming.java_spring.jdk_dynamic_proxy.advanced.ChargableCalculatorUnionedInterfaceImpl;
import pers.xiaoming.java_spring.jdk_dynamic_proxy.advanced.ChargableCalculatorUnionedInterfaceProxy;
import pers.xiaoming.java_spring.jdk_dynamic_proxy.advanced.ChargerImpl;

public class ChargableCalculatorTest {
    /*
        Exception throws in line 41 at ChargableCalculatorSeparatedInterfacesProxy.java
        java.lang.ClassCastException: com.sun.proxy.$Proxy4 cannot be cast to pers.xiaoming.java_spring.jdk_dynamic_proxy.advanced.ChargableCalculatorSeparatedInterfacesImpl
     */
